...
export const Skills: React.FC = () => {
  return (
    <div className="h-screen w-screen bg-blue-200 pt-32 text-white-200">
      ...
      <div className="grid grid-cols-1 justify-center gap-14 font-neuropol text-2xl tracking-wider md:grid-cols-2 md:gap-0 md:px-40 xl:text-4xl">
        <div className="mx-auto text-center">
          TECK STACKS
          <div className="flex flex-col gap-3 pt-5 font-orbitron text-base md:gap-6 md:pt-14 xl:text-2xl">
            <p>Next.js (React)</p>
            <p>TypeScript</p>
            <p>WebGL, Three.js</p>
