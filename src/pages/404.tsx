...
export default function Custom404() {
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center gap-8 bg-black-100">
      <RevealText
        text="404 - Page Not Found"
        className="font-earth text-2xl tracking-tighter text-yellow-100 md:text-3xl lg:text-5xl"
      />
